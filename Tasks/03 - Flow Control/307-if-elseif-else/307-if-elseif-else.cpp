...
{
    //Some constants 
    const int high = 95, medium = 70, low = 30, dangerouslyLow = 5;
    ...
    {
        cout << "Tank is dangerously low and needs filling immediately!" << endl;
    }
    ...
    {
        cout << "Tank has a sufficient amount of fuel, but could do with some more." << endl;
    }
    else if (level <= high) 
    {
